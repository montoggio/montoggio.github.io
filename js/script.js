...
//  colose menu clock outsite ///////////////////
subWrapper.onclick = function () {
  subWrapper.style.display = 'none';
...
//  colose menu clock outsite   END /////////// ////////


// calendar  onclick //////////
// let calendarSvg = document.getElementById('Capa_1');
// let cal = document.getElementById('cal');
// calendarSvg.onclick = function () {
//   cal.focus();
//   console.log('Capa_1');
// }
...
checkout.onclick = function () {
  ...
  if (wrapperPopupMenu.classList.contains('closed')) {
    ...
    for (let i = 0; i < toOrder.length; i++) {
      ...
      if (toOrderNum > 0) {
        ...
        let codArtic = toOrder[i].parentNode.parentNode
        ...
        ///////////////// находится внутри элемента codArtic
        codArtic = codArtic.querySelector('.desc .codArtic').textContent;
        console.log(codArtic)
        // if (codArtic.contains('.codArtic') == true) {
        // }
        ...
        outItem += ' <div class="formGroup gridForSendForm">';
        outItem += '  <div class="descItem">';
        outItem += '    ' + ralDesc + '';
        outItem += '  </div>';
        outItem += '  <div class="nameItem">';
        ...
        outItem += '  </div>';
        outItem += '  <div class="codArtic">' + codArtic + '</div>';
    ...
    for (let i = 0; i < ralInFormGroup.length; i++) {
      ...
      console.log(nameDistributore)
      let nameItem = ralInFormGroup[i].previousElementSibling.textContent
      ...
      //   ACRILFIN   &      NITROCROM
      if (ralInFormGroupNum == 3014 || ralInFormGroupNum == 3015
        || ralInFormGroupNum == 5000 || ralInFormGroupNum == 5001
        || ralInFormGroupNum == 5003 || ralInFormGroupNum == 5004
        || ralInFormGroupNum == 5005 || ralInFormGroupNum == 5007
        || ralInFormGroupNum == 5008 || ralInFormGroupNum == 5009
        || ralInFormGroupNum == 5010 || ralInFormGroupNum == 5011
        || ralInFormGroupNum == 5012 || ralInFormGroupNum == 5014
        || ralInFormGroupNum == 5015 || ralInFormGroupNum == 5017
        || ralInFormGroupNum == 5018 || ralInFormGroupNum == 5019
        || ralInFormGroupNum == 5020 || ralInFormGroupNum == 5021
        || ralInFormGroupNum == 5023 || ralInFormGroupNum == 6004
        || ralInFormGroupNum == 6016 || ralInFormGroupNum == 6026
        || ralInFormGroupNum == 6033 || ralInFormGroupNum == 8004
        || ralInFormGroupNum == 8024 || ralInFormGroupNum == 9006
        || ralInFormGroupNum == 9007
        && nameDistributore == 'COLOR MARKET S.R.L.') {
        codArtic.innerHTML = 'S.541001GR2';

      }
      else if (ralInFormGroupNum == 1003 || ralInFormGroupNum == 1004
        || ralInFormGroupNum == 1005 || ralInFormGroupNum == 1006
        || ralInFormGroupNum == 1007 || ralInFormGroupNum == 1012
        || ralInFormGroupNum == 1016 || ralInFormGroupNum == 1017
        || ralInFormGroupNum == 1018 || ralInFormGroupNum == 1021
        || ralInFormGroupNum == 1023 || ralInFormGroupNum == 1027
        || ralInFormGroupNum == 1028 || ralInFormGroupNum == 1032
        || ralInFormGroupNum == 1033 || ralInFormGroupNum == 1034
        || ralInFormGroupNum == 1037 || ralInFormGroupNum == 2000
        || ralInFormGroupNum == 2001 || ralInFormGroupNum == 2002
        || ralInFormGroupNum == 2003 || ralInFormGroupNum == 2004
        || ralInFormGroupNum == 2008 || ralInFormGroupNum == 2009
        || ralInFormGroupNum == 2010 || ralInFormGroupNum == 2011
        || ralInFormGroupNum == 2012 || ralInFormGroupNum == 3000
        || ralInFormGroupNum == 3001 || ralInFormGroupNum == 3002
        || ralInFormGroupNum == 3003 || ralInFormGroupNum == 3004
        || ralInFormGroupNum == 3004 || ralInFormGroupNum == 3005
        || ralInFormGroupNum == 3007 || ralInFormGroupNum == 3011
        || ralInFormGroupNum == 3013 || ralInFormGroupNum == 3016
        || ralInFormGroupNum == 3017 || ralInFormGroupNum == 3018
        || ralInFormGroupNum == 3020 || ralInFormGroupNum == 3022
        || ralInFormGroupNum == 3027 || ralInFormGroupNum == 3031
        || ralInFormGroupNum == 4001 || ralInFormGroupNum == 4002
        || ralInFormGroupNum == 4003 || ralInFormGroupNum == 4004
        || ralInFormGroupNum == 4005 || ralInFormGroupNum == 4006
        || ralInFormGroupNum == 4007 || ralInFormGroupNum == 4008
        || ralInFormGroupNum == 4010 || ralInFormGroupNum == 5002
        || ralInFormGroupNum == 5013 || ralInFormGroupNum == 5022
        || ralInFormGroupNum == 6000 || ralInFormGroupNum == 6001
        || ralInFormGroupNum == 6002 || ralInFormGroupNum == 6005
        || ralInFormGroupNum == 6007 || ralInFormGroupNum == 6008
        || ralInFormGroupNum == 6009 || ralInFormGroupNum == 6010
        || ralInFormGroupNum == 6012 || ralInFormGroupNum == 6014
        || ralInFormGroupNum == 6017 || ralInFormGroupNum == 6018
        || ralInFormGroupNum == 6022 || ralInFormGroupNum == 6024
        || ralInFormGroupNum == 6025 || ralInFormGroupNum == 6028
        || ralInFormGroupNum == 6029 || ralInFormGroupNum == 6032
        || ralInFormGroupNum == 8003 || ralInFormGroupNum == 8007
        || ralInFormGroupNum == 8008 || ralInFormGroupNum == 8011
        || ralInFormGroupNum == 8014 || ralInFormGroupNum == 8016
        || ralInFormGroupNum == 8017 || ralInFormGroupNum == 8023
        || ralInFormGroupNum == 8028 && nameDistributore == 'COLOR MARKET S.R.L.') {

        codArtic.innerHTML = 'S.541001GR3';
      }
      else if (nameDistributore == 'COLOR MARKET S.R.L.') {

        codArtic.innerHTML = 'S.541001GR1';
      }
      // SPRAY ACRILICO 
      if (nameItem == '    SPRAY ACRILICO  ') {
        codArtic.innerHTML = '3ARE';
      }
    ...
    wrapperPopunOutName_Quantity.innerHTML += '<button type="submit" class="buttonPopupMenuChec">Check-out</button>';
  ...
  let buttonPopupMenuChec = document.querySelector('.buttonPopupMenuChec');
  console.log(buttonPopupMenuChec);
  buttonPopupMenuChec.onclick = function (e) {
    e.preventDefault();
    // let PostItems = {
    //   'descItem': '',
    //   'nameItem': '',
    ...
    for (let i = 0; i < formGroup.length; i++) {
      ...
      let descItem = formGroup[i].querySelector('.descItem').textContent;
      console.log(descItem);
      let nameItem = formGroup[i].querySelector('.nameItem').textContent;
      console.log(nameItem);
      let quantityItem = formGroup[i].querySelector('.quantityItem>input').value;
      console.log(quantityItem);
      let codArtic = formGroup[i].querySelector('.codArtic').textContent;
      console.log(codArtic);
      let fornitore = formGroup[i].querySelector('.nameDistributore').textContent;
      console.log(fornitore);
      let datta = formGroup[i].querySelector('.datta').textContent;
      console.log(datta);
      PostItems += [
        [descItem, nameItem, quantityItem, codArtic, fornitore, datta]
      ]
    }
...
let ralPolAll1000 = [1001, 1017, 1021, 1023];
